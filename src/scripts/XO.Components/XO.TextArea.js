        ...
        change(n, v) {
            switch (n) {
                case "value":
                    ...
                    if ((this.$.text.scrollHeight) === 57) this.$.text.style.height = "40px";
                    else this.$.text.style.height = (this.$.text.scrollHeight) + "px";
    ...
    static callbacks = {
        ...
        attach() {
            ...
            this.$.text.addEventListener("input", e => {
                ...
                if ((e.target.scrollHeight) === 57) e.target.style.height = "40px";
    ...
    render() {
        return /*html*/ `
            <a role="input" id="xo-container">
                ...
                <section>
                    <textarea id="xo-text" rows="1"></textarea>
